...
def get_seed_list(xml_file, base_url, url_part=""):
    ...
    for child in root:
        ...
        if url_part in full_url:
            ...
            for level in filter(lambda val: val != "" and val != "http:" and
                                val != base_url and not val.isdigit(),
                                url_split):
...
def get_and_parse_jamieoliver_sitemap():
    ...
    get_sitemap("http://www.jamieoliver.com/recipes/", "sitemap.xml", xml_file_path,
                compressed=False)
...
def get_and_parse_myrecipes_sitemap():
    ...
    get_sitemap("http://www.myrecipes.com/", "recipe-sitemap.xml?page=1", xml_file_path,
                compressed=False)
    ...
    get_sitemap("http://www.myrecipes.com/", "recipe-sitemap.xml?page=2", xml_file_path,
                compressed=False)
    seed_list = get_seed_list(xml_file_path, "myrecipes.com")
